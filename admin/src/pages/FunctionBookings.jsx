...
import { Calendar, Users, Mail, Phone, MessageSquare, CheckCircle, Trash2 } from 'lucide-react';
...
export default function FunctionBookings() {
    ...
    const fetchBookings = async () => {
        try {
            setLoading(true);
            const response = await hospitalityAPI.getFunctionBookings();
    ...
    const handleComplete = async (bookingId) => {
        ...
        try {
            ...
            const response = await hospitalityAPI.updateFunctionBookingStatus(bookingId, 'completed');

            if (response.data && response.data.success) {
                toast.success('Moved to Event History');
                fetchBookings();
            } else {
    ...
    const handleDelete = async (bookingId) => {
        ...
        try {
            ...
            const response = await hospitalityAPI.deleteFunctionBooking(bookingId);
        ...
        <div className="bookings-container">
            <div className="bookings-header">
                <h1 className="bookings-title">
                    {isHistory ? 'Event History' : 'Function Room Enquiries'}
                </h1>
            </div>
            ...
            <div className="table-card">
                <div className="overflow-x-auto">
                    <table className="bookings-table">
                        <thead>
                            <tr>
                                <th className="col-guest">Contact Info</th>
                                <th className="col-date">Event Date</th>
                            ...
                            {displayedBookings.length === 0 && (
                                <tr>
                                    <td colSpan="5" className="empty-state">
                                        No {isHistory ? 'completed' : 'active'} enquiries found.
                                    </td>
                                </tr>
                            )}
                        </tbody>
